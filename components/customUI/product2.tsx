...
const Product2: FC<Product2> = ({ className }) => {
  const product1Features = [
    'ALL NOTIFICATION WILL SHOW ON DIGITAL LCD DISPLAY',
    ...
    'STARTER WATER SENSOR SUPPORTED TOTAL FOUR POINT HIGH LELVEL, LOW LEVEL AND TWO MID LEVEL.',
    'WATER SENSOR TYPE NO (NORMAL OPEN)',
    'DO DAILY TIMER ON AND OFF WITH REAL CLOCK.',
    'OVER FLOW TIME SET',
    ...
    'LONG LIFE',
    'STARTER WIDE RANGE VOLTAGE SUPPORT (150 VOLT TO 320 VOLT)',
    'MAXIMUM LOAD CAPACITY UP TO 20 AMP',
    'EMERGENCY SWITCH',
    'STARTER TYPE DOL',
    ' THIS STARTER IS AVAILABLE IN SINGLE PHASE AND THREE PHASE',
    ' IN THREE PHASE CONNECTION NEUTRAL LINE IS NECESSARY.',
    'EASY INSTALLATION',
  ];
  return (
    <div
    ...
    >
      <div className=" flex justify-center font-montserrat font-bold border-[2px] p-2 text-red-800 text-[12px] text-center lg:mt-[47px] lg:mb-[14px] lg:p-4 lg:text-2xl">
